...
export const string: TypeGuard<string> = (value: unknown): string => {
...
export const number: TypeGuard<number> = (value: unknown): number => {
...
export const constString = <T extends string>(constValue: T): TypeGuard<T> => {
    return (value: unknown) => {
        if (string(value) === constValue) {
            return constValue;
        }
